...
func (r Redirects) Size() int32 {
	// #nosec G115 - integer overflow is possible but unlikely to ever occur due to the data we're operating on here
	return int32(len(r.Entries)) * RedirectSize
}
